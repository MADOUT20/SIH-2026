...
export async function getMitreAttackChain(): Promise<AttackChainResponse> {
  return apiRequest<AttackChainResponse>("/api/mitre/attack-chain")
}

export async function getMitreStages(): Promise<AttackChainResponse> {
  return apiRequest<AttackChainResponse>("/api/mitre/stages")
}
