...
const tabLabels: Record<string, string> = {
  ...
  ml: "Logistic Regression Baseline vs. AI Benchmark",
  mitre: "MITRE ATT&CK Stage Mapping & Kill-Chain",
  scanner: "Website Threat Scanner & Warning",
...
export function DashboardHeader({ activeTab, onTabChange, onMenuClick }: DashboardHeaderProps) {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const stored = localStorage.getItem("netguard_app_mode") as "live" | "demo"
      if (stored) setAppMode(stored)
    }
  }, [])
