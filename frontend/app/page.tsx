...
import { Activity, BrainCircuit, Database, Network, RefreshCw, SearchCheck, ShieldAlert, Layers, Globe } from "lucide-react"
...
const progressItems = [
  {
    ...
    value: 100,
    note: "High-performance packet capture and live normalization active.",
    icon: Activity,
  },
  {
    title: "MITRE ATT&CK stage mapping",
    value: 100,
    note: "Label predictions with real attack-stage names & 14-stage kill-chain matrix.",
    icon: Layers,
  },
  {
    title: "Malware & trojan website warning shield",
    value: 100,
    note: "Real-time website threat scanner and proxy warning interception.",
    icon: Globe,
  },
  {
    title: "Packet & flow feature extraction",
    value: 100,
    note: "Extracted 12-dimensional ML feature vectors from live network packets.",
    icon: SearchCheck,
  },
  {
    title: "Logistic Regression & AI Ensemble baseline",
    value: 100,
    note: "Dual-model benchmarking with F1, FPR, ROC-AUC, and latency scores.",
    icon: BrainCircuit,
  },
  {
    title: "Real-time threat hunting & response",
    value: 100,
    note: "Live lead hunting, automated DNS sinkholing, and domain blocking.",
    icon: ShieldAlert,
  },
]
