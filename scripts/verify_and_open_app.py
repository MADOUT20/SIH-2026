...
def verify_and_launch():
    ...
    if not backend_running:
        ...
        backend_exe = os.path.join(repo_root, "dist", "NetGuard", "backend", "netguard-backend.exe")
    ...
    if not frontend_running:
        ...
        frontend_js = os.path.join(repo_root, "dist", "NetGuard", "frontend", "server.js")
    ...
    if not https_running:
        ...
        gateway_py = os.path.join(repo_root, "scripts", "https_gateway.py")
