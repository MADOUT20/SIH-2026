...
def run_real_windows_pcap_verification():
    ...
    npcap_status = "NOT INSTALLED (Service 1060)"
    npcap_ver = "1.88 (Downloaded at d:\\SIH-2026-demo\\npcap-1.88.exe)"
    npcap_ok = False
    try:
    ...
    if not npcap_ok:
        ...
        print(" Please run d:\\SIH-2026-demo\\npcap-1.88.exe to install Npcap.")
        print("===================================================")
        return False
    ...
    try:
        ...
        artifacts_dir = os.path.abspath(r"d:\SIH-2026-demo\models\trained")
