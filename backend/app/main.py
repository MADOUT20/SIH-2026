...
async def startup_event():
    ...
    # Continuous background Scapy live packet capture loop
    async def continuous_pcap_loop():
        while True:
            try:
                await packet_service.capture_packets(timeout=5)
            except Exception:
                await asyncio.sleep(2)

    asyncio.create_task(continuous_pcap_loop())
