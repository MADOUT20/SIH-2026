...
async def get_attack_forecast(request: Optional[ForecastRequest] = None):
    ...
    Accepts sequence of network-state windows or current packet snapshot.
    Returns current attack probability, 5-step future forecast timeline, predicted stage, and top feature attributions.
    """
    packets = packet_service.packets
